...
func (t *TransposeConvOptionsT) Pack(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
	if t == nil { return 0 }
	TransposeConvOptionsStart(builder)
	TransposeConvOptionsAddPadding(builder, t.Padding)
	TransposeConvOptionsAddStrideW(builder, t.StrideW)
	TransposeConvOptionsAddStrideH(builder, t.StrideH)
...
func (rcv *TransposeConvOptions) UnPack() *TransposeConvOptionsT {
	if rcv == nil { return nil }
	t := &TransposeConvOptionsT{}
	rcv.UnPackTo(t)
	return t
}
