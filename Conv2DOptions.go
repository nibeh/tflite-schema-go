...
func (t *Conv2DOptionsT) Pack(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
	if t == nil { return 0 }
	Conv2DOptionsStart(builder)
	Conv2DOptionsAddPadding(builder, t.Padding)
	Conv2DOptionsAddStrideW(builder, t.StrideW)
	Conv2DOptionsAddStrideH(builder, t.StrideH)
	Conv2DOptionsAddFusedActivationFunction(builder, t.FusedActivationFunction)
	Conv2DOptionsAddDilationWFactor(builder, t.DilationWFactor)
	Conv2DOptionsAddDilationHFactor(builder, t.DilationHFactor)
