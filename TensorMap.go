...
func (t *TensorMapT) Pack(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
	if t == nil { return 0 }
	nameOffset := builder.CreateString(t.Name)
	TensorMapStart(builder)
	TensorMapAddName(builder, nameOffset)
	TensorMapAddTensorIndex(builder, t.TensorIndex)
	return TensorMapEnd(builder)
}

func (rcv *TensorMap) UnPackTo(t *TensorMapT) {
	t.Name = string(rcv.Name())
	t.TensorIndex = rcv.TensorIndex()
}
