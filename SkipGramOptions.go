...
func (t *SkipGramOptionsT) Pack(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
	if t == nil { return 0 }
	SkipGramOptionsStart(builder)
	SkipGramOptionsAddNgramSize(builder, t.NgramSize)
	SkipGramOptionsAddMaxSkipSize(builder, t.MaxSkipSize)
	SkipGramOptionsAddIncludeAllNgrams(builder, t.IncludeAllNgrams)
	return SkipGramOptionsEnd(builder)
}

func (rcv *SkipGramOptions) UnPackTo(t *SkipGramOptionsT) {
	t.NgramSize = rcv.NgramSize()
	t.MaxSkipSize = rcv.MaxSkipSize()
	t.IncludeAllNgrams = rcv.IncludeAllNgrams()
}
