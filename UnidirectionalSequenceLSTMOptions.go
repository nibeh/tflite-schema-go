...
func (t *UnidirectionalSequenceLSTMOptionsT) Pack(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
	if t == nil { return 0 }
	UnidirectionalSequenceLSTMOptionsStart(builder)
	UnidirectionalSequenceLSTMOptionsAddFusedActivationFunction(builder, t.FusedActivationFunction)
	UnidirectionalSequenceLSTMOptionsAddCellClip(builder, t.CellClip)
	UnidirectionalSequenceLSTMOptionsAddProjClip(builder, t.ProjClip)
	UnidirectionalSequenceLSTMOptionsAddTimeMajor(builder, t.TimeMajor)
	UnidirectionalSequenceLSTMOptionsAddAsymmetricQuantizeInputs(builder, t.AsymmetricQuantizeInputs)
	return UnidirectionalSequenceLSTMOptionsEnd(builder)
}

func (rcv *UnidirectionalSequenceLSTMOptions) UnPackTo(t *UnidirectionalSequenceLSTMOptionsT) {
...
func (rcv *UnidirectionalSequenceLSTMOptions) UnPack() *UnidirectionalSequenceLSTMOptionsT {
	if rcv == nil { return nil }
	t := &UnidirectionalSequenceLSTMOptionsT{}
	rcv.UnPackTo(t)
	return t
}
