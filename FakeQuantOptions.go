...
func (t *FakeQuantOptionsT) Pack(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
	if t == nil { return 0 }
	FakeQuantOptionsStart(builder)
	FakeQuantOptionsAddMin(builder, t.Min)
	FakeQuantOptionsAddMax(builder, t.Max)
	FakeQuantOptionsAddNumBits(builder, t.NumBits)
	FakeQuantOptionsAddNarrowRange(builder, t.NarrowRange)
...
func (rcv *FakeQuantOptions) UnPackTo(t *FakeQuantOptionsT) {
	t.Min = rcv.Min()
	t.Max = rcv.Max()
	t.NumBits = rcv.NumBits()
	t.NarrowRange = rcv.NarrowRange()
}
