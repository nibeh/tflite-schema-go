...
func (t *SVDFOptionsT) Pack(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
	if t == nil { return 0 }
	SVDFOptionsStart(builder)
	SVDFOptionsAddRank(builder, t.Rank)
	SVDFOptionsAddFusedActivationFunction(builder, t.FusedActivationFunction)
	SVDFOptionsAddAsymmetricQuantizeInputs(builder, t.AsymmetricQuantizeInputs)
