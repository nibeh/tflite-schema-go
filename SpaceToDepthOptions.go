...
func (t *SpaceToDepthOptionsT) Pack(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
	if t == nil { return 0 }
	SpaceToDepthOptionsStart(builder)
	SpaceToDepthOptionsAddBlockSize(builder, t.BlockSize)
...
func (rcv *SpaceToDepthOptions) UnPack() *SpaceToDepthOptionsT {
	if rcv == nil { return nil }
	t := &SpaceToDepthOptionsT{}
	rcv.UnPackTo(t)
	return t
}
