...
func (t *FullyConnectedOptionsT) Pack(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
	if t == nil { return 0 }
	FullyConnectedOptionsStart(builder)
	FullyConnectedOptionsAddFusedActivationFunction(builder, t.FusedActivationFunction)
	FullyConnectedOptionsAddWeightsFormat(builder, t.WeightsFormat)
	FullyConnectedOptionsAddKeepNumDims(builder, t.KeepNumDims)
	FullyConnectedOptionsAddAsymmetricQuantizeInputs(builder, t.AsymmetricQuantizeInputs)
	return FullyConnectedOptionsEnd(builder)
}

func (rcv *FullyConnectedOptions) UnPackTo(t *FullyConnectedOptionsT) {
	t.FusedActivationFunction = rcv.FusedActivationFunction()
	t.WeightsFormat = rcv.WeightsFormat()
	t.KeepNumDims = rcv.KeepNumDims()
	t.AsymmetricQuantizeInputs = rcv.AsymmetricQuantizeInputs()
}

func (rcv *FullyConnectedOptions) UnPack() *FullyConnectedOptionsT {
	if rcv == nil { return nil }
	t := &FullyConnectedOptionsT{}
	rcv.UnPackTo(t)
	return t
}
