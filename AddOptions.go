...
func (t *AddOptionsT) Pack(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
	if t == nil { return 0 }
	AddOptionsStart(builder)
	AddOptionsAddFusedActivationFunction(builder, t.FusedActivationFunction)
	AddOptionsAddPotScaleInt16(builder, t.PotScaleInt16)
