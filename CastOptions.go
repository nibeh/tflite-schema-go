...
func (t *CastOptionsT) Pack(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
	if t == nil { return 0 }
	CastOptionsStart(builder)
	CastOptionsAddInDataType(builder, t.InDataType)
	CastOptionsAddOutDataType(builder, t.OutDataType)
	return CastOptionsEnd(builder)
}

func (rcv *CastOptions) UnPackTo(t *CastOptionsT) {
	t.InDataType = rcv.InDataType()
	t.OutDataType = rcv.OutDataType()
}
