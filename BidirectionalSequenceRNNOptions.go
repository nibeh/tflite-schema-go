...
func (t *BidirectionalSequenceRNNOptionsT) Pack(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
	if t == nil { return 0 }
	BidirectionalSequenceRNNOptionsStart(builder)
	BidirectionalSequenceRNNOptionsAddTimeMajor(builder, t.TimeMajor)
	BidirectionalSequenceRNNOptionsAddFusedActivationFunction(builder, t.FusedActivationFunction)
	BidirectionalSequenceRNNOptionsAddMergeOutputs(builder, t.MergeOutputs)
	BidirectionalSequenceRNNOptionsAddAsymmetricQuantizeInputs(builder, t.AsymmetricQuantizeInputs)
	return BidirectionalSequenceRNNOptionsEnd(builder)
}

func (rcv *BidirectionalSequenceRNNOptions) UnPackTo(t *BidirectionalSequenceRNNOptionsT) {
...
func (rcv *BidirectionalSequenceRNNOptions) UnPack() *BidirectionalSequenceRNNOptionsT {
	if rcv == nil { return nil }
	t := &BidirectionalSequenceRNNOptionsT{}
	rcv.UnPackTo(t)
	return t
}
