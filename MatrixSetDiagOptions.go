...
func (t *MatrixSetDiagOptionsT) Pack(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
	if t == nil { return 0 }
...
func (rcv *MatrixSetDiagOptions) UnPack() *MatrixSetDiagOptionsT {
	if rcv == nil { return nil }
	t := &MatrixSetDiagOptionsT{}
	rcv.UnPackTo(t)
	return t
}
