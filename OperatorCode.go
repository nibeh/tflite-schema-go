...
func (t *OperatorCodeT) Pack(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
	if t == nil { return 0 }
	customCodeOffset := builder.CreateString(t.CustomCode)
	OperatorCodeStart(builder)
	OperatorCodeAddDeprecatedBuiltinCode(builder, t.DeprecatedBuiltinCode)
	OperatorCodeAddCustomCode(builder, customCodeOffset)
	OperatorCodeAddVersion(builder, t.Version)
	OperatorCodeAddBuiltinCode(builder, t.BuiltinCode)
	return OperatorCodeEnd(builder)
}

func (rcv *OperatorCode) UnPackTo(t *OperatorCodeT) {
	t.DeprecatedBuiltinCode = rcv.DeprecatedBuiltinCode()
	t.CustomCode = string(rcv.CustomCode())
	t.Version = rcv.Version()
	t.BuiltinCode = rcv.BuiltinCode()
}
